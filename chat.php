  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        <li class="active"><a href="welcome.php">Exit chat</a></li>
	...
	<?php
	    if(isset($_POST['chatName'])){
	    	...
	    	$q = "INSERT INTO chat_rooms(room_name) Values ('$chatName')";
	    	$result = mysqli_query($link,$q);
	    	$query=mysqli_query($link,"SELECT * FROM chat_rooms WHERE room_name = '$chatName'");
	    }

	    if(isset($_POST['chatid'])){
	    	$chatid = $_POST['chatid'];
	    	$query=mysqli_query($link,"SELECT * FROM chat_rooms WHERE chat_room_id = '$chatid'");
	    }
		...
		while($row=mysqli_fetch_array($query)){
			?>
				...
				<div>
				Chat Room id: <span style="color:black;"><?php echo $row['chat_room_id']; ?></span><br><br>
				</div>
				<form>
